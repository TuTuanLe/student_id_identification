<div class="menu-pri "  style="background: #FBAE40;">
    <div class="container">
        <div class="panel-left" style="background: #FBAE40;">
            <!--MOBILE-->
            <nav class="navbar navbar-default hidden-md hidden-lg" role="navigation">
                <div class="container-fluid" style="background: #FBAE40;">
        ...
        <div class="col-md-12 col-lg-12 panel-right hidden-xs text-center" style="background: #FBAE40;">
